...
var range_WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    key: "CDmark",
    value: function CDmark(editable) {
      return {
        s: {
    ...
    /**
     * create offsetPath CDmark base on paragraph
     *
     * @param {Node[]} paras
     */
    ...
    key: "paraCDmark",
    value: function paraCDmark(paras) {
      return {
        s: {
...
/* harmony default export */ var range = ({
   ...
   * @method
   *
   * create WrappedRange from CDmark
   *
   * @param {Node} editable
   * @param {Object} CDmark
   * @return {WrappedRange}
   */
  createFromCDmark: function createFromCDmark(editable, CDmark) {
    var sc = dom.fromOffsetPath(editable, CDmark.s.path);
    var so = CDmark.s.offset;
    var ec = dom.fromOffsetPath(editable, CDmark.e.path);
    var eo = CDmark.e.offset;
    return new range_WrappedRange(sc, so, ec, eo);
  },
   ...
   * @method
   *
   * create WrappedRange from paraCDmark
   *
   * @param {Object} CDmark
   * @param {Node[]} paras
   * @return {WrappedRange}
   */
  createFromParaCDmark: function createFromParaCDmark(CDmark, paras) {
    var so = CDmark.s.offset;
    var eo = CDmark.e.offset;
    var sc = dom.fromOffsetPath(lists.head(paras), CDmark.s.path);
    var ec = dom.fromOffsetPath(lists.last(paras), CDmark.e.path);
    return new range_WrappedRange(sc, so, ec, eo);
  }
});
  ...
  History_createClass(History, [{
    ...
    value: function makeSnapshot() {
      ...
      return {
        ...
        CDmark: rng && rng.isOnEditable() ? rng.CDmark(this.editable) : emptyCDmark
      };
    }
  }, {
    key: "applySnapshot",
    value: function applySnapshot(snapshot) {
      ...
      if (snapshot.CDmark !== null) {
        range.createFromCDmark(this.editable, snapshot.CDmark).select();
      }
    }
    /**
    * @method rewind
...
var Bullet_Bullet = /*#__PURE__*/function () {
  ...
  Bullet_createClass(Bullet, [{
    ...
    value: function toggleList(listName, editable) {
      ...
      var CDmark = rng.paraCDmark(paras);
      ...
      range.createFromParaCDmark(CDmark, paras).select();
    }
    /**
     * @param {Node[]} paras
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      var fbRegExp = /(?:www\.|\/\/)faceCD\.com\/([^\/]+)\/videos\/([0-9]+)/;
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<iframe>').attr('frameborder', 0).attr('src', 'https://www.faceCD.com/plugins/video.php?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560').attr('width', '560').attr('height', '301').attr('scrolling', 'no').attr('allowtransparency', 'true');
      } else {
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    codeviewIframeWhitelistSrcBase: ['www.youtube.com', 'www.youtube-nocookie.com', 'www.faceCD.com', 'vine.co', 'instagram.com', 'player.vimeo.com', 'www.dailymotion.com', 'player.youku.com', 'v.qq.com'],
    keyMap: {
      pc: {
        'ESC': 'escape',
