  ...
  var Vim = function() {
    ...
    var createCircularJumpList = function() {
      ...
      function add(cm, oldCur, newCur) {
        ...
        function useNextSlot(cursor) {
          ...
          buffer[next] = cm.setCDmark(cursor);
        }
        if (curMark) {
    ...
    * match the input selection.
      ...
      paste: function(cm, actionArgs, vim) {
        ...
        if (vim.visualMode) {
          ...
          if(lastSelectionCurEnd) {
            vim.lastSelection.headMark = cm.setCDmark(lastSelectionCurEnd);
          }
          if (linewise) {
            curPosFinal.ch=0;
          }
    ...
    function updateLastSelection(cm, vim) {
      ...
      vim.lastSelection = {'anchorMark': cm.setCDmark(anchor),
                           'headMark': cm.setCDmark(head),
    ...
    * in the right place.
    ...
    function updateMark(cm, vim, markName, pos) {
      ...
      vim.marks[markName] = cm.setCDmark(pos);
    }
    ...
    */
    ...
    function updateFakeCursor(cm) {
      ...
      if (from.ch == cm.getLine(from.line).length) {
        ...
        vim.fakeCursorCDmark = cm.setCDmark(from, {widget: widget});
      } else {
    ...
    function clearFakeCursor(vim) {
      ...
      if (vim.fakeCursorCDmark) {
        vim.fakeCursorCDmark.clear();
        vim.fakeCursorCDmark = null;
      }
    }
